...
version 43
__lua__
local l={}r={I={{{1,0},{1,1},{1,2},{1,3}},{{0,2},{1,2},{2,2},{3,2}},{{2,0},{2,1},{2,2},{2,3}},{{0,1},{1,1},{2,1},{3,1}}},O={{{0,1},{0,2},{1,1},{1,2}}},T={{{0,1},{1,0},{1,1},{1,2}},{{0,1},{1,1},{1,2},{2,1}},{{1,0},{1,1},{1,2},{2,1}},{{0,1},{1,0},{1,1},{2,1}}},S={{{0,1},{0,2},{1,0},{1,1}},{{0,1},{1,1},{1,2},{2,2}},{{1,1},{1,2},{2,0},{2,1}},{{0,0},{1,0},{1,1},{2,1}}},Z={{{0,0},{0,1},{1,1},{1,2}},{{0,2},{1,1},{1,2},{2,1}},{{1,0},{1,1},{2,1},{2,2}},{{0,1},{1,0},{1,1},{2,0}}},J={{{0,0},{1,0},{1,1},{1,2}},{{0,1},{0,2},{1,1},{2,1}},{{1,0},{1,1},{1,2},{2,2}},{{0,1},{1,1},{2,0},{2,1}}},L={{{0,2},{1,0},{1,1},{1,2}},{{0,1},{1,1},{2,1},{2,2}},{{1,0},{1,1},{1,2},{2,0}},{{0,0},{0,1},{1,1},{2,1}}}}_={I=1,O=2,T=3,S=4,Z=5,J=6,L=7}y={[1]={[2]={{0,0},{0,-1},{-1,-1},{2,0},{2,-1}},[4]={{0,0},{0,1},{-1,1},{2,0},{2,1}}},[2]={[1]={{0,0},{0,1},{1,1},{-2,0},{-2,1}},[3]={{0,0},{0,1},{1,1},{-2,0},{-2,1}}},[3]={[2]={{0,0},{0,-1},{-1,-1},{2,0},{2,-1}},[4]={{0,0},{0,1},{-1,1},{2,0},{2,1}}},[4]={[3]={{0,0},{0,-1},{1,-1},{-2,0},{-2,-1}},[1]={{0,0},{0,-1},{1,-1},{-2,0},{-2,-1}}}}I={[1]={[2]={{0,0},{0,-2},{0,1},{1,-2},{-2,1}},[4]={{0,0},{0,-1},{0,2},{-2,-1},{1,2}}},[2]={[1]={{0,0},{0,2},{0,-1},{-1,2},{2,-1}},[3]={{0,0},{0,-1},{0,2},{-2,-1},{1,2}}},[3]={[2]={{0,0},{0,1},{0,-2},{2,1},{-1,-2}},[4]={{0,0},{0,2},{0,-1},{-1,2},{2,-1}}},[4]={[3]={{0,0},{0,-2},{0,1},{1,-2},{-2,1}},[1]={{0,0},{0,1},{0,-2},{2,1},{-1,-2}}}}function l:new(e,o,l,d)local n={}n.shapeId=e n.shape=r[e][o]n.rotation=o n.row=l n.column=d n.spr=_[e]self.__index=self setmetatable(n,self)return n end function l:rotate(n)self.rotation=(self.rotation+n)%#r[self.shapeId]+1self.shape=r[self.shapeId][self.rotation]end function l:set_rotation(n)self.rotation=n self.shape=r[self.shapeId][self.rotation]end n={}function n:new(e,o,l,d,t,f)local n={}n.name=e n.label=o n.is_victory=l n.is_defeat=d n.on_update=t n.on_init=f self.__index=self setmetatable(n,self)return n end function e()return function(n)return false end end function o()return function(n)end end function i()return function(n)end end u={n:new("casual","clear 15 lines",function(n)return n.lines_cleared>=15end,e(),o(),i()),n:new("marathon","clear 150 lines",function(n)return n.lines_cleared>=150end,e(),o(),i()),n:new("quickie","clear 15 lines in 3 minutes",function(n)return n.lines_cleared>=15and n.frame_count<=10800end,function(n)return n.frame_count>10800end,function(n)n.time_remaining-=1end,function(n)n.time_remaining=10800n.time_mode="countdown"end),n:new("reverse","use 40 pieces without, clearing a line",function(n)return n.pieces_used==40and n.lines_cleared==0end,function(n)return n.lines_cleared>0end,o(),i()),n:new("expert","reach level 20",function(n)return n.level>=5end,e(),o(),i()),n:new("heavy g","survive 2 minutes,blocks fall faster",function(n)return n.frame_count>=7200end,e(),o(),function(n)n.drop_interval_max=5n.drop_interval=5end),n:new("perfect","get a perfect clear,no pieces after clearing lines",function(n)local e=#n.grid for o=1,#n.grid[1]do if(n.grid[e][o]~=n.grid_spr)return false
...
end function n:update_end_anim()local n=self.end_anim local e,e=n.mode=="defeat",{}for o,n in ipairs(n.pops)do n.timer+=1if(n.timer==n.duration)self:spawn_end_particles(n)
...
elseif#n.pops==0do n.done=true end if(n.done and btnp(5))v"menu"
...
local n=n[flr(rnd(#n))+1]local e=n.spr local e,o=sget(e%16*8+3,flr(e/16)*8+3),self.end_anim.mode=="defeat"local o=o and 1or 7self.grid[n.row][n.col]=self.grid_spr if(self.end_anim.mode=="victory")self.shake_x=3self.shake_y=3
add(self.end_anim.pops,{row=n.row,col=n.col,color=e,flash_col=o,timer=0,duration=12})end function n:spawn_end_particles(n)local l,d,e=self.board_x+(n.col-1)*self.block_size+self.block_size/2,self.board_y+(n.row-1)*self.block_size+self.block_size/2,self.end_anim.mode=="defeat"local t,n=e and 2or 4,e and 1or n.color for e=1,t do local e,l=l+(rnd(self.block_size)-self.block_size/2),d+(rnd(self.block_size)-self.block_size/2)add(self.particles,o:new(e,l,n))end end function n:update_line_clear_animation()self.animation.timer+=1if(self.animation.timer>=self.animation.duration)self.state=e.PLAYING self:clear_completed_lines()self:finish_turn()
...
local n if(self.active_piece.shapeId=="I")n=I else n=y
...
if(self.selected==2)if btnp(1)do sfx(1)self.selected_challenge=self.selected_challenge%#u+1elseif btnp(0)do sfx(0)self.selected_challenge=(self.selected_challenge-2)%#u+1end
self.selected=mid(1,self.selected,#self.items)if btnp(5)or btnp(4)do if self.selected==1do?"⁷2s4i0v3c3e3g3c4 "
self.flash_timer=self.flash_total elseif self.selected==2do elseif self.selected==3do c=not c if(c==false)music(-1,1000)else music(12,1000)
...
local o=self.items[n]if n==2do o="mode: "..self:current_challenge().name elseif n==3do o="music "..(c and"on"or"off")end local f=#o*4local e,l,d=e+(l-f)/2,t+(d-6)/2+1if(n==self.selected and self.flash_timer>0)d=self.flash_timer%4==0and 7or 5else d=n==self.selected and 7or 5
?o,e,l,d
...
self.timer+=1if self.phase=="fade_out"and self.timer>=self.duration do v(self.target_mode)self.phase="fade_in"self.timer=0if(self.target_mode=="playing"and c)music(21,1000*self.duration/60,4)
...
fillp(d[n]+.5)rectfill(0,0,127,127,0)fillp()end function _init()poke(24366,1)T=false k={[0]=0,0,1,1,2,1,5,6,2,4,9,3,1,1,2,5}a="menu"p=nil g=e:new()f=o:new()c=false end function _update60()if a=="playing"do p:update_world()w()elseif a=="menu"do g:update_menu()end f:update()end function _draw()cls(0)if a=="playing"do p:draw_world()b()elseif a=="menu"do g:draw_menu()end if(f.active)f:draw()
O()end function v(e)pal()if(e=="playing")p=n:new(g:current_challenge())
a=e end function S(n)add(x,n)end function O()for n in all(x)do?n,50,50,7
end x={}end
__gfx__
