...
end local n=nil if e>0do n=self.is_tspin and"tspin"or self.is_mini_tspin and"mini_tspin"or"lines"elseif self.is_tspin do n="tspin"elseif self.is_mini_tspin do n="mini_tspin"end return o,n end function n:update_score(n,e)if n=="lines"do local n,o={100,300,500,800},{180,300,480,720}self:update_score_line_clear(n,o,e)elseif n=="tspin"do local n,o={[0]=100,[1]=400,[2]=800,[3]=1200,[4]=1600},{300,600,900,1200}self:update_score_line_clear(n,o,e)elseif n=="mini_tspin"do local n,o={[0]=100,[1]=200,[2]=400},{180,360}self:update_score_line_clear(n,o,e)elseif n=="soft_drop"do self:add_score(e)elseif n=="hard_drop"do self:add_score(e*2)end end function n:add_score(n)self.score_hi,self.score_lo=g(self.score_hi,self.score_lo,n,10000)end function n:hs_slot()return self.challenge.index-1end function n:save_hs()if(self.state==e.GAME_OVER and self.challenge.is_victory~=nil)return
...
local e,o=dget(n+30),dget(n+20)local l=e==0and o==0if(l or self.secs_hi<e or self.secs_hi==e and self.secs_lo<o)dset(n+20,self.secs_lo)dset(n+30,self.secs_hi)
...
local e=n*6000+e local n,e=e\60,e%60return(n<10and"0"..n or tostring(n))..":"..(e<10and"0"..e or tostring(e))end function n:update_score_line_clear(e,o,n)self.lines_cleared+=n self.level=flr(self.lines_cleared/10)+1self.drop_interval=max(5,self.drop_interval_max-(self.level*2-2))self:add_score(e[n]*self.level)if(self.challenge.name=="rush"and self.time_remaining and n>0)self.time_remaining+=o[n]
...
end function n:draw_end_stats()local n,e,o=68,"score:"..self:score_str(),"best: "..self:hs_str()?e,32-#e*2,n,5
?o,96-#o*2,n,5
n+=8e,o="time: "..self:get_time(),"bst t:"..self:hs_time_str()?e,32-#e*2,n,5
?o,96-#o*2,n,5
end function n:draw_defeat_banner(n)local e=min(16,n)if(n>60)e=min(64,16+(n-60))
rectfill(0,64-e,127,63,0)rectfill(0,64,127,64+e-1,0)if n>30do?"game over",45,54,1
...
return tostring(self.score_hi)..n end return tostring(self.score_lo)end function n:get_time()local e=self.secs_hi*6000+self.secs_lo local n,e=flr(e/60),e%60local n,e=tostring(n<10and"0"..n or n),tostring(e<10and"0"..e or e)return n..":"..e end function v(n,e,o,l,d)local t,o=#n*4,o-e local e=e+(o-t)/2?n,e,l,d
...
end function n:draw_diagonal_lines()pal(11,129,1)local n=time()*20%16for e=-128,128,8do local o,n=e+n,e+128+n line(o,128,n,0,11)end end function g(o,n,l,e)n+=l if(n>=e)o+=flr(n/e)n=n%e
...
fillp(d[n]+.5)rectfill(0,0,127,127,0)fillp()end function _init()cartdata"yapt"poke(24366,1)S=false k={[0]=0,0,1,1,2,1,5,6,2,4,9,3,1,1,2,5}c="menu"m=nil p=e:new()f=o:new()i=false end function _update60()if c=="playing"do m:update_world()w()elseif c=="menu"do p:update_menu()end f:update()end function _draw()cls(0)if c=="playing"do m:draw_world()b()elseif c=="menu"do p:draw_menu()end if(f.active)f:draw()
T()end function O(e)pal()if(e=="playing")m=n:new(p:current_challenge())
c=e end function Z(n)add(y,n)end function T()for n in all(y)do?n,50,50,7
end y={}end
__gfx__
