...
end n.pops=e local e=self:end_anim_count_filled()if e>0do local n=max(1,flr(e/44))for n=1,n do if(self:end_anim_count_filled()>0)self:end_anim_pop_random_block()
end elseif#n.pops==0do if(not n.done)self:save_hs()
...
local e if(n.shapeId=="I")e=x else e=v
...
return s(n*6000+e)end function n:update_score_line_clear(e,o,n)self.lines_cleared+=n self.level=flr(self.lines_cleared/10)+1self.drop_interval=max(5,self.drop_interval_max-(self.level*2-2))self:add_score(e[n]*self.level)if(self.challenge.name=="rush"and self.time_remaining and n>0)self.time_remaining+=o[n]
...
self:reset_action_state()end function n:lock_active_piece()for e,n in pairs(self.active_piece.shape)do local e,n=self.active_piece.row+n[1],self.active_piece.column+n[2]self.grid[e][n]=self.active_piece.spr end self:check_tspin()self.can_hold=true self.pieces_used+=1end function n:check_tspin()self.is_tspin=false self.is_mini_tspin=false local n=self.active_piece if(n.shapeId~="T"or self.last_action~="rotation")return
local o,l,e=n.row+1,n.column+1,{[1]={A={-1,-1},B={-1,1},C={1,-1},D={1,1}},[2]={A={-1,1},B={1,1},C={-1,-1},D={1,-1}},[3]={A={1,-1},B={1,1},C={-1,-1},D={-1,1}},[4]={A={-1,-1},B={1,-1},C={-1,1},D={1,1}}}local e,n=e[n.rotation],{A=false,B=false,C=false,D=false}for d,e in pairs(e)do local o,e=o+e[1],l+e[2]if(not self:is_position_valid(o,e)or self.grid[o][e]~=self.grid_spr)n[d]=true
end local e=0for o,n in pairs(n)do if(n)e+=1
...
end function n:can_move(o,l)local n=self.active_piece for e in all(n.shape)do local o,n=n.row+o+e[1],n.column+l+e[2]if(not self:is_position_valid(o,n))return false
...
return s(n)end function s(n)local n,e=n\60,n%60return(n<10and"0"..n or tostring(n))..":"..(e<10and"0"..e or tostring(e))end function m(n,e,o,l,d)local t,o=#n*4,o-e local e=e+(o-t)/2?n,e,l,d
...
end function e:bevel_box(n,e,o,l)rect(n-1,e-1,n+o,e+l,7)rect(n-2,e-2,n+o+1,e+l+1,0)for o=0,o-1do for l=0,l-1do self:darken_pixel(n+o,e+l)end end end function e:draw_diagonal_lines()pal(6,129,1)local n=time()*20%16for e=-128,128,8do local o,n=e+n,e+128+n line(o,128,n,0,6)end end function e:draw_cursor(o,l,n)n=n or 1local d={2,3,4,5,4,3,2}for e=0,6do for d=1,d[e+1]-2do pset(o+d*n,l+e,7)end end end function e:draw_challenge_description(n,e)local o=self:current_challenge().label local o,n=split(o),n+e+5for e in all(o)do local o=#e*4?e,(127-o)/2,n,5
n+=6end end function e:draw_menu()self:draw_diagonal_lines()local n=time()local n=sin(n*.5)*2circfill(63.5,14.5+n+19,31,0)circfill(63.5,14.5+n+19,30,1)for n=1,15do pal(n,I[n])end spr(16,34.5,14.5+n+2,62,38)pal(0)spr(16,32.5,14.5+n,62,38)end local o={}o.__index=o local d={0,32768,32896,34952,54613,43690,61149,61166,-18,-1}local l=#d function o:new()local n={}n.active=false n.target_mode=nil n.timer=0n.duration=30n.phase="idle"setmetatable(n,self)return n end function o:start(n,e)music(-1,1000*self.duration/60)self.active=true self.from_mode=n self.target_mode=e self.timer=0self.phase="fade_out"end function o:blocks_input()return self.active end function o:update()if(not self.active)return
self.timer+=1if self.phase=="fade_out"and self.timer>=self.duration do T(self.target_mode)self.phase="fade_in"self.timer=0if(self.target_mode=="playing"and i)music(21,1000*50/60,1)
...
fillp(d[n]+.5)rectfill(0,0,127,127,0)fillp()end function _init()cartdata"lex_yapt"poke(24366,1)I={[0]=0,0,1,1,2,1,5,6,2,4,9,3,1,1,2,5}c="menu"u=e:new()f=o:new()i=true music(12)end function _update60()if c=="playing"do p:update_world()_()elseif c=="menu"do u:update_menu()end f:update()end function _draw()cls(0)if c=="playing"do p:draw_world()w()elseif c=="menu"do u:draw_menu()end if(f.active)f:draw()
end function T(e)pal()if(e=="playing")p=n:new(u:current_challenge())
c=e end
__gfx__
...
02 1f20220d
__label__

...

