...
version 43
__lua__
local l={}r={I={{{1,0},{1,1},{1,2},{1,3}},{{0,2},{1,2},{2,2},{3,2}},{{2,0},{2,1},{2,2},{2,3}},{{0,1},{1,1},{2,1},{3,1}}},O={{{0,1},{0,2},{1,1},{1,2}}},T={{{0,1},{1,0},{1,1},{1,2}},{{0,1},{1,1},{1,2},{2,1}},{{1,0},{1,1},{1,2},{2,1}},{{0,1},{1,0},{1,1},{2,1}}},S={{{0,1},{0,2},{1,0},{1,1}},{{0,1},{1,1},{1,2},{2,2}},{{1,1},{1,2},{2,0},{2,1}},{{0,0},{1,0},{1,1},{2,1}}},Z={{{0,0},{0,1},{1,1},{1,2}},{{0,2},{1,1},{1,2},{2,1}},{{1,0},{1,1},{2,1},{2,2}},{{0,1},{1,0},{1,1},{2,0}}},J={{{0,0},{1,0},{1,1},{1,2}},{{0,1},{0,2},{1,1},{2,1}},{{1,0},{1,1},{1,2},{2,2}},{{0,1},{1,1},{2,0},{2,1}}},L={{{0,2},{1,0},{1,1},{1,2}},{{0,1},{1,1},{2,1},{2,2}},{{1,0},{1,1},{1,2},{2,0}},{{0,0},{0,1},{1,1},{2,1}}}}x={I=1,O=2,T=3,S=4,Z=5,J=6,L=7}_={[1]={[2]={{0,0},{0,-1},{-1,-1},{2,0},{2,-1}},[4]={{0,0},{0,1},{-1,1},{2,0},{2,1}}},[2]={[1]={{0,0},{0,1},{1,1},{-2,0},{-2,1}},[3]={{0,0},{0,1},{1,1},{-2,0},{-2,1}}},[3]={[2]={{0,0},{0,-1},{-1,-1},{2,0},{2,-1}},[4]={{0,0},{0,1},{-1,1},{2,0},{2,1}}},[4]={[3]={{0,0},{0,-1},{1,-1},{-2,0},{-2,-1}},[1]={{0,0},{0,-1},{1,-1},{-2,0},{-2,-1}}}}I={[1]={[2]={{0,0},{0,-2},{0,1},{1,-2},{-2,1}},[4]={{0,0},{0,-1},{0,2},{-2,-1},{1,2}}},[2]={[1]={{0,0},{0,2},{0,-1},{-1,2},{2,-1}},[3]={{0,0},{0,-1},{0,2},{-2,-1},{1,2}}},[3]={[2]={{0,0},{0,1},{0,-2},{2,1},{-1,-2}},[4]={{0,0},{0,2},{0,-1},{-1,2},{2,-1}}},[4]={[3]={{0,0},{0,-2},{0,1},{1,-2},{-2,1}},[1]={{0,0},{0,1},{0,-2},{2,1},{-1,-2}}}}function l:new(e,o,l,d)local n={}n.shapeId=e n.shape=r[e][o]n.rotation=o n.row=l n.column=d n.spr=x[e]self.__index=self setmetatable(n,self)return n end function l:rotate(n)self.rotation=(self.rotation+n)%#r[self.shapeId]+1self.shape=r[self.shapeId][self.rotation]end function l:set_rotation(n)self.rotation=n self.shape=r[self.shapeId][self.rotation]end n={}function n:new(e,o,l,d,t,f)local n={}n.name=e n.label=o n.is_victory=l n.is_defeat=d n.on_update=t n.on_init=f self.__index=self setmetatable(n,self)return n end function e()return function(n)return false end end function o()return function(n)end end function c()return function(n)end end u={n:new("casual","clear 15 lines",function(n)return n.lines_cleared>=1end,e(),o(),c()),n:new("marathon","clear 150 lines",function(n)return n.lines_cleared>=150end,e(),o(),c()),n:new("quickie","clear 15 lines in 3 minutes",function(n)return n.lines_cleared>=15and n.frame_count<=10800end,function(n)return n.frame_count>10800end,function(n)n.time_remaining-=1end,function(n)n.time_remaining=10800n.time_mode="countdown"end),n:new("reverse","use 40 pieces without, clearing a line",function(n)return n.pieces_used==40and n.lines_cleared==0end,function(n)return n.lines_cleared>0end,o(),c()),n:new("expert","reach level 20",function(n)return n.level>=5end,e(),o(),c()),n:new("heavy g","survive 2 minutes,blocks fall faster",function(n)return n.frame_count>=7200end,e(),o(),function(n)n.drop_interval_max=5n.drop_interval=5end),n:new("perfect","get a perfect clear,no pieces after clearing lines",function(n)local e=#n.grid for o=1,#n.grid[1]do if(n.grid[e][o]~=n.grid_spr)return false
end return n.lines_cleared>0end,e(),o(),c()),n:new("tight","you only have 6 columns",function(n)end,e(),function(n)local e,o=#n.grid,{1,2,9,10}for e=3,e do for o in all(o)do if(n.grid[e][o]==n.grid_spr)n.grid[e][o]=flr(rnd(7))+1
...
if self.state==e.PLAYING do self.frame_lo+=1if(self.frame_lo>=60)self.frame_lo=0self.secs_hi,self.secs_lo=v(self.secs_hi,self.secs_lo,1,6000)
...
n.done=true end if(n.done and btnp(5))f:start("playing","menu")
...
local e if(n.shapeId=="I")e=I else e=_
...
end local n=nil if e>0do n=self.is_tspin and"tspin"or self.is_mini_tspin and"mini_tspin"or"lines"elseif self.is_tspin do n="tspin"elseif self.is_mini_tspin do n="mini_tspin"end return o,n end function n:update_score(n,e)if n=="lines"do local n,o={[1]=100,[2]=300,[3]=500,[4]=800},{[1]=180,[2]=300,[3]=480,[4]=720}self:update_score_line_clear(n,o,e)elseif n=="tspin"do local n,o={[0]=100,[1]=400,[2]=800,[3]=1200,[4]=1600},{[1]=300,[2]=600,[3]=900,[4]=1200}self:update_score_line_clear(n,o,e)elseif n=="mini_tspin"do local n,o={[0]=100,[1]=200,[2]=400},{[1]=180,[2]=360}self:update_score_line_clear(n,o,e)elseif n=="soft_drop"do self:add_score(e)elseif n=="hard_drop"do self:add_score(e*2)end end function n:add_score(n)self.score_hi,self.score_lo=v(self.score_hi,self.score_lo,n,10000)end function n:hs_slot()return self.challenge.index-1end function n:save_hs()local n=self:hs_slot()local e,o=dget(n+10),dget(n)if(self.score_hi>e or self.score_hi==e and self.score_lo>o)dset(n,self.score_lo)dset(n+10,self.score_hi)
end function n:hs_str()local n=self:hs_slot()local e,n=dget(n+10),dget(n)if e>0do local n=tostring(n)while(#n<4)n="0"..n
return tostring(e)..n end return tostring(n)end function n:update_score_line_clear(e,o,n)self.lines_cleared+=n self.level=flr(self.lines_cleared/10)+1self.drop_interval=max(5,self.drop_interval_max-(self.level*2-2))self:add_score(e[n]*self.level)if(self.challenge.name=="rush"and self.time_remaining and n>0)self.time_remaining+=o[n]
...
end function n:draw_end_stats()?"score:"..self:score_str(),40,68,5
?"best: "..self:hs_str(),40,74,5
?"time: "..self:get_time(),40,80,5
end function n:draw_defeat_banner(n)local e=min(16,n)if(n>60)e=min(64,16+(n-60))
rectfill(0,64-e,127,63,0)rectfill(0,64,127,64+e-1,0)if n>30do?"game over",44,54,1
if(n>60)self:draw_end_stats()
end end function n:draw_victory_banner(n)local e=min(16,n)if(n>60)e=min(64,16+(n-60))
rectfill(0,0,127,e,0)rectfill(0,127-e,127,127,0)if n>30do?"victory!",48,60,7
if(n>60)self:draw_end_stats()
end end function n:draw_text_info()local n,e=61,2d("pieces",e,self.board_x-1,n,self.ui_color)n+=6d(tostring(self.pieces_used),e,self.board_x-1,n,self.ui_color)n+=12d("lines",e,self.board_x-1,n,self.ui_color)n+=6d(tostring(self.lines_cleared),e,self.board_x-1,n,self.ui_color)n+=12d("level",e,self.board_x-1,n,self.ui_color)n+=6d(tostring(self.level),e,self.board_x-1,n,self.ui_color)n+=12d("score",e,self.board_x-1,n,self.ui_color)n+=6d(self:score_str(),e,self.board_x-1,n,self.ui_color)n,e=97,self.board_x+self.block_size*#self.grid[1]+2d("mode",e,127,n,self.ui_color)n+=6d(tostring(self.challenge.name),e,127,n,self.ui_color)n+=12d("timer",e,127,n,self.ui_color)n+=6d(self:get_time(),e,127,n,self.ui_color)end function n:score_str()if self.score_hi>0do local n=tostring(self.score_lo)while(#n<4)n="0"..n
return tostring(self.score_hi)..n end return tostring(self.score_lo)end function n:get_time()local e=self.secs_hi*6000+self.secs_lo local n,e=flr(e/60),e%60local n,e=tostring(n<10and"0"..n or n),tostring(e<10and"0"..e or e)return n..":"..e end function d(n,e,o,l,d)local t,o=#n*4,o-e local e=e+(o-t)/2?n,e,l,d
...
end function n:draw_diagonal_lines()pal(11,129,1)local n=time()*20%16for e=-128,128,8do local o,n=e+n,e+128+n line(o,128,n,0,11)end end function v(o,n,l,e)n+=l if(n>=e)o+=flr(n/e)n=n%e
...
self.timer+=1if self.phase=="fade_out"and self.timer>=self.duration do O(self.target_mode)self.phase="fade_in"self.timer=0if(self.target_mode=="playing"and i)music(21,1000*50/60,4)
if(self.target_mode=="menu"and i)music(12,1000*50/60,4)
...
fillp(d[n]+.5)rectfill(0,0,127,127,0)fillp()end function _init()cartdata"yapt"poke(24366,1)S=false k={[0]=0,0,1,1,2,1,5,6,2,4,9,3,1,1,2,5}a="menu"p=nil g=e:new()f=o:new()i=false end function _update60()if a=="playing"do p:update_world()w()elseif a=="menu"do g:update_menu()end f:update()end function _draw()cls(0)if a=="playing"do p:draw_world()b()elseif a=="menu"do g:draw_menu()end if(f.active)f:draw()
T()end function O(e)pal()if(e=="playing")p=n:new(g:current_challenge())
a=e end function Z(n)add(y,n)end function T()for n in all(y)do?n,50,50,7
end y={}end
__gfx__
